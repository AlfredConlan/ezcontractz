                        ...
                        <Navbar.Toggle aria-controls='responsive-navbar-nav' />
                            <Navbar.Collapse id='responsive-navbar-nav' className="justify-content-end">
                                <Nav>
                                    ...
                                    <Link to='/taskList' style={{textDecoration:'none'}} className = "nav-link">Tasks</Link>
                                    <Link to='/Profile' style={{textDecoration:'none'}} className = "nav-link">Profile</Link>
                                    <Link to='/AboutUs'style={{textDecoration:'none'}} className ="nav-link">AboutUs</Link>
                                </Nav>
                            </Navbar.Collapse>
                    </Container>
            </Navbar> 
